export default {
  META_DESCRIPTION: 'TheMaxChange Exchange is the Swiss knife for decentralized finance! Yield-based Liquidity Pools | Limit Trading | NFT Market and much more!',
  META_TITLE: 'EOS trustless DEX.',
  META_NFT_MARKET_TITLE: 'TheMaxChange NFT Market | Trustless NFT market on WAX chain',
  META_NFT_MARKET_DESCRIPTION: 'Atomic, no fee, NFT marketplace.',
  HERO_DESCRIPTION: 'TheMaxChange is a lego of decentralized finance built on multi-chain, and a provider of solutions in one tap.',
  ...
  LEARNMORE: 'Learn more about TheMaxChange, chat with the community, and get announcements faster than anyone.',
  ...
  'With TheMaxChange you can trade any EOS.IO tokens for system EOS tokens, atomically, without the participation of third parties! The tokens should comply with the standard eosio.token of the contract': 'With TheMaxChange you can trade any EOS.IO tokens for system EOS tokens, atomically, without the participation of third parties! The tokens should comply with the standard eosio.token of the contract',
  Fully: 'Fully',
  onchain: 'onchain',
  ...
  'TheMaxChange DAO coming soon': 'TheMaxChange DAO coming soon',
  'TheMaxChange Revenue Distribution': 'TheMaxChange Revenue Distribution',
